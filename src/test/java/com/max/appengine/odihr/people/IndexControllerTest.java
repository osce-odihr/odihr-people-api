...
package com.max.appengine.odihr.people;
...
@SpringBootTest(classes = OdihrPeopleApplication.class)
public class IndexControllerTest {
  protected static final Logger log = LoggerFactory.getLogger(IndexControllerTest.class);
